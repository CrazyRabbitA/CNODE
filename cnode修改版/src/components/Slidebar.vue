...
<div class="panel">
                  ...
                  <div class="other-topic">
                    ...
                    <div class="inner">
                      <router-link :to="{name:'artical_content',params:{id:recenttopic.id,loginname:recenttopic.author.loginname}}"
                  ...
                  <div class="recent-response">
                    ...
                    <div class="inner">
                      <router-link :to="{name:'artical_content',params:{id:recentresponse .id,loginname:recentresponse .author.loginname}}"
